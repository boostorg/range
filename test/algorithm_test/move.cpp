...
namespace boost
{
    namespace
    {
        ...
        void test_move()
        {
            test_move_impl< std::vector<copy_movable> >(true);
            test_move_impl< std::list<copy_movable> >(true);
            test_move_impl< std::set<copy_movable> >(false);
            test_move_impl< std::multiset<copy_movable> >(false);
        }
    }
}
